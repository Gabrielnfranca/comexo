...
import NovoNcmForm from '../novo/NovoNcmForm'
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-500 dark:text-slate-400 text-sm mt-0.5">Cadastre um código NCM com suas alíquotas</p>
      </div>
      <NovoNcmForm />
    </div>
  )
